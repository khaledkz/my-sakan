    ...
    render(){
         ...
         <div className="sigleFlatInner">
            ...
            <div className="innerFirstPart">
                ...
                <h3> Address: <span className="innerText">{this.props.city} {this.props.street} {this.props.flatNumber} {this.props.postCode}.</span> </h3>
            </div>

            <h2 class="text-title" >Letting Description:</h2>
            <p>   
